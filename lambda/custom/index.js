...
{
    let sentence = item.AnimalName + " makes a " + item.AnimalSound + " sound.";
    return sentence;
}
...
{
    return "Here is your " + counter + "th question.  What is the " + formatCasing(property) + " of "  + item.AnimalName + "?";
...
{
    return "The " + formatCasing(property) + " of " + item.AnimalName + " is " + item[property] + ". "
}
...
const WELCOME_MESSAGE = "Welcome to the Animal Guess Game!  You can ask me about animal sounds, or you can ask me to start a quiz.  What would you like to do?";

//This is the message a user will hear when they start a quiz.
const START_QUIZ_MESSAGE = "OK.  I will ask you 4 animal sound questions.";

//This is the message a user will hear when they try to cancel or stop the skill, or when they finish a quiz.
const EXIT_SKILL_MESSAGE = "Thank you for playing the Animal Guess Game!  Let's play again soon!";

//This is the message a user will hear after they ask (and hear) about a specific data element.
const REPROMPT_SPEECH = "Which other animal sound would you like to know about?";

//This is the message a user will hear when they ask Alexa for help in your skill.
const HELP_MESSAGE = "I know lots of things about animal sounds.  You can ask me about a animal, and I'll tell you what sound they make .  You can also test your knowledge by asking me to start a quiz.  What would you like to do?";
